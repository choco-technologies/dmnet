...
dmod_dmnet_api_declaration(1.0, dmnet_t, _create, ( void ))
{
    ...
    struct dmnet *instance = Dmod_Malloc(sizeof(*instance));
    if (instance == NULL)
    {
        return NULL;
    }
...
dmod_dmnet_api_declaration(1.0, void, _destroy, ( dmnet_t handle ))
{
    Dmod_Free(handle);
}

dmod_dmnet_api_declaration(1.0, bool, _is_valid, ( dmnet_t handle ))
{
