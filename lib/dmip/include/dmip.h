 ...
 *         `-ENOSYS` for `dmip_family_v6` (no dmip_v6_send() yet - see the
 *         comment above dmip_v6_reassemble()'s declaration for why);
 *         `-EINVAL` if `header` is NULL or `header->family` is neither
 */
